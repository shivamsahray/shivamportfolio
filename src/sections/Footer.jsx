    ...
    <footer className="relative overflow-hidden bg-black" >
      ...
      <motion.div 
        ...
        >
          ...
          <div className="h-[3px] w-24 md:w-32 rounded-full bg-gradient-to-r from-[#0d58cc] via-cyan-300 to-emrald-400" />
          ...
          <p className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} Shivam Sahray. All rights reserved.
          </p>
